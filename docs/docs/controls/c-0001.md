...
[publicRegistries](../frameworks-and-controls/configuring-controls.md#public-registries)
Kubescape checks none of these public container registries are in use.

### Registries block list

[untrustedRegistries](../frameworks-and-controls/configuring-controls.md#registries-block-list)
